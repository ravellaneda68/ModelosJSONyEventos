		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices Odata",
									"targetURL": "#invoicesodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicesodata-display": {
								"semanticObject": "invoicesodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoicesodata",
									"url": sap.ui.require.toUrl("invoicesodata")
								}
							}
						}
					}
