		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "odatainvoices",
									"targetURL": "#logaligroupodatainvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupodatainvoices-display": {
								"semanticObject": "logaligroupodatainvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.odatainvoices",
									"url": sap.ui.require.toUrl("logaligroup/odatainvoices")
								}
							}
						}
					}
